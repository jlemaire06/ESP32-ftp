...
/*
  ...
  based on Jean-Michel Gallego's work : https://github.com/gallegojm/Arduino-Ftp-Server/tree/master/FtpServer
  based on David Paiva (david@nailbuster.com)'s work : https://github.com/nailbuster/esp8266FTPServer

  Modified by Jacques Lemaire:
  - only for ESP32
...
boolean FtpServer::userPassword()
{
  ...
  else if ( strcmp( "anonymous", _FTP_USER.c_str() ) && strcmp( parameters, _FTP_PASS.c_str() ))  // Modif JL
    client.println( "530 ");
  else
  {
#ifdef FTP_DEBUG
